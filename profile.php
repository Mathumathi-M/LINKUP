...
if(isset($_SESSION['name'])&&isset($_SESSION['email'])) {
    ...
    $sqllogin=" SELECT * FROM dataprofile WHERE email='$email'  "; 
     ...
     <div class="row  mt-5 justify-content-center" >
        <div class="col-5 ">
          <div class="card">
            ...
            <ul class="list-group">
  <li class="list-group-item">NAME <span><?php echo $username; ?></span></li>
  <li class="list-group-item">EMAIL <span><?php echo $email; ?></span> </li>
  <li class="list-group-item">GENDER <span><?php echo $gender; ?></span></li>
  <li class="list-group-item">PHONE NUMBER <span><?php echo $phno;  ?></span></li>
  
</ul>
<div class="m-4" style="text-align:center;">
    
<a class="btn btn-danger text-light" href="./signin.php"  > SIGN OUT<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
