	 ...
	 <nav class="navbar navbar-light  sticky-top bg-light">
        <div class="container-fluid">
          <a class="navbar-brand" href="#">
            <img src="./image/U-ezgif.com-crop.gif" alt="" width="50" height="55" class="d-inline-block align-text-top">
...
<!-- Here's the inline SVG icon -->
          ...
          <a class="navbar-brand" href="#">
            <figure>
             <img src="./image/home-svg.svg" alt="home" width="35" height="35" class="d-inline-block align-text-top" style="margin-top: 100;">
             <figcaption class="image">Home</figcaption>
            </figure>
          </a>
          <a class="navbar-brand" href="#">
            <figure>
            <img src="./image/chat-png.png" alt="home" width="30" height="30" class="d-inline-block align-text-top">
            <figcaption class="image">Message</figcaption>
          </figure>
          </a>
          <a class="navbar-brand" href="#">
            <figure>
            <img src="./image/notification-png.png" alt="home" width="30" height="30" class="d-inline-block align-text-top">
            <figcaption class="image">Notification</figcaption>
          </figure>
          </a>
          <a class="navbar-brand" href="#">
            <figure>
            <img src="./image/crown-png.png" alt="home" width="30" height="30" class="d-inline-block align-text-top">
            <figcaption class="image">Premium</figcaption>
          </figure>
          </a>
          <a class="navbar-brand" href="#">
            <figure>
            <img src="./image/profile.png" alt="home" width="30" height="30" class="d-inline-block align-text-top" style="border-radius: 50%;">
            <figcaption class="image">My Profile</figcaption>
          </figure>
          </a>
          <a class="navbar-brand" href="#">
            <figure>
            <img src="./image/grid.png" alt="home" width="30" height="25" class="d-inline-block align-text-top">
		...
		<div class="row justify-content-center"> 
            ...
            <div  class="mb-3"  style="text-align:center;" >
             <div class="h2 text-primary p-3">SIGN UP</div>
              <img src="./image/profile.png" alt="PROFILE" style="border-radius: 50%;" width="20%" height="20%">
            </div>
						<form id="registrationform" action="./signin.php" method="post" name="registrationform"> 
